...
void WhoIsThis(const v8::FunctionCallbackInfo<v8::Value>& args) {  
  v8::Isolate* isolate = args.GetIsolate();
  auto message = v8::String::NewFromUtf8(isolate, "I'm a duck!");
...
void Increment(const v8::FunctionCallbackInfo<v8::Value>& args) {  
  ...
  if (numberOfCalls + argsValue > maxValue) {
    isolate->ThrowException(v8::Exception::Error(
          v8::String::NewFromUtf8(isolate, "Counter exeeds!")));
    return;
  }
...
void Initialize(v8::Local<v8::Object> exports) {  
  NODE_SET_METHOD(exports, "whoisthis", WhoIsThis);
